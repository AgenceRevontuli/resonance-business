...
<div class="form-container">
	<form class="multistep-form"<?php $view->formAttributes(); ?>>
		...
		<?php elseif ( $view instanceof MM_WPFS_SubscriptionFormView ): ?>
			<?php if ( count( $view->plans()->options() ) > 1 ): ?>
				...
				<?php elseif ( MM_WPFS::PLAN_SELECTOR_STYLE_LIST === $form->planSelectorStyle ): ?>
					<fieldset class="wpfs-form-check-group step" id="step1">
						<div class="step--content">
							<h2>Choix de la formule d'abonnement</h2>
							<p>Pour votre adhésion, deux choix possible. Vous pouvez régler votre adhésion mensuellement (avec engagement sur 12 mois) ou régler l'année en un seul réglement (1 mois offert avec cette option).</p>
						</div>
					<div class="fields">
						<legend class="wpfs-form-check-group-title"><?php $view->plans()->label(); ?></legend>
							...
							<?php endforeach; ?>
							<div class="nextbtn">
								<button type="button" class="next" id="next1">Suivant</button>
							</div>
					</div>
					</fieldset>
				<?php endif; ?>
		...
		<?php if ( $showCustomInputGroup ): ?>
			<div class="customgroup step" id="step2">
				...
				<div class="buttons">
					<div class="prevsec">
						<button type="button" class="previous" id="back1">Précédent</button>
					</div>
					<div class="nextsec">
						<button type="button" class="next" id="next2">Suivant</button>
					</div>
				</div>
		...
		<div class="card-check step" id="step5">
		<div class="paiement-details">
			<h4>Détails de l'adhésion</h4>
			<div class="wpfs-details" data-tooltip-id="<?php echo esc_attr( 'wpfs-form-summary-' . $view->getFormHash() ); ?>">
					<div class="wpfs-summary">
						<table class="wpfs-summary-table">
							...
							<tr class="wpfs-summary-table-row" data-wpfs-summary-row="subscription">
								<td class="wpfs-summary-table-cell" data-wpfs-summary-row-label="subscription" data-wpfs-summary-row-label-value="<?php echo esc_attr( '%d%s %s' ); ?>">HT<?php /* translators: Label for the subscription plan line item */
									esc_html_e( 'Subscription plan', 'wp-full-stripe' ); ?>HT</td>
							...
							<tr class="wpfs-summary-table-total" data-wpfs-summary-row="total">
								<td class="wpfs-summary-table-cell" data-wpfs-summary-row-label="total"><?php /* translators: Label for the total price  */
									esc_html_e( 'Total', 'wp-full-stripe' ); ?> TTC</td>
		...
		<div class="wpfs-form-actions buttons">
			<button  type="button" class="prevfourth previous" id="back2">
				Précédent
			</button>
